...
class MemberAdmin(admin.ModelAdmin):
    list_display = (
        'membership_id', 'full_name', 'tsc_number',
        'school', 'sub_county', 'is_active',
    )
    list_filter = ('is_active', 'sub_county')
    search_fields = (
        'membership_id', 'first_name', 'last_name', 'tsc_number', 'school',
    )
    ...
    fieldsets = (
        ('Identity', {'fields': (
            'membership_id', 'tsc_number', 'first_name', 'last_name', 'user',
        )}),
